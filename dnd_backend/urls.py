...
from users.views import UserCharacterView, UserCharacterControl, UserCharacterSpells
...
urlpatterns = [
    ...
    path('api/users/<int:user_id>/characters/<int:character_id>/spells/', UserCharacterSpells.as_view()),
]
