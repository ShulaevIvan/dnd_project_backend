...
from users.views import UserCharacterView, UserCharacterControl, UserCharacterSpellsView, UserCharacterInventoryView, UserCharacterEquippedItemsView
...
urlpatterns = [
    ...
    path('api/users/<int:user_id>/characters/<int:character_id>/inventory/equipped-items/', UserCharacterEquippedItemsView.as_view()),
]
